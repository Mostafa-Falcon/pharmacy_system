...
class BranchesManagementView extends StatelessWidget {
  const BranchesManagementView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: sl<BranchesBloc>(),
      child: const _BranchesManagementBody(),
    );
  }
}

class _BranchesManagementBody extends StatelessWidget {
  const _BranchesManagementBody();
