...
class AdminStrings {
  ...
  static const String sidebarGroupSales = 'إدارة المبيعات';
  static const String sidebarGroupPurchases = 'المشتريات والموردين';
  static const String sidebarGroupInventory = 'الأدوية والمخزون';
  static const String sidebarGroupReports = 'التقارير والمالية';
  static const String sidebarGroupAdmin = 'الإدارة والنظام';
  ...
  static const String sidebarItemStocktaking = 'فترات الجرد';
  static const String sidebarItemInventoryTools = 'أدوات المخزون';
  static const String sidebarItemStockTransfer = 'تحويل مخزون';
  static const String sidebarItemStockAdjustment = 'تسوية المخزون';
  static const String sidebarItemBulkPriceUpdate = 'تحديث الأسعار الجماعي';
  static const String sidebarItemPromotions = 'العروض والترقيات';
  static const String sidebarItemImportItems = 'استيراد أدوية';
