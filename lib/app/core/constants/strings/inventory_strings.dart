...
class InventoryStrings {
  ...
  static const String importMedicinesDesc = 'اختر ملف Excel (xlsx) بصيغة الأصناف لتحميله إلى قاعدة البيانات.';
  ...
  static const String importNoData = 'لم يتم العثور على بيانات صالحة للاستيراد في الملف.';
  ...
  static const String importSnackbarNoData = 'لم يتم العثور على بيانات صالحة للاستيراد في الملف';
  ...
  static const String importBranchMissing = 'لم يتم العثور على معرف الفرع الحالي.';
  ...
  static const String importStepParsing = 'جاري تحليل البيانات واستخراج الأصناف...';
  static const String importStepSaving = 'جاري حفظ الأصناف في قاعدة البيانات...';
  ...
  static const String importNewImport = 'استيراد جديد';

  // ─── Inventory ───
  static const String inventoryTitle = 'قائمة الأدوية والمخزون';
  static const String inventorySubtitle = 'إدارة الأصناف والأسعار والكميات المتوفرة في المخزن';
  ...
  static const String expiryTrackingOptional = 'تتبع تاريخ انتهاء الصلاحية (اختياري)';
  ...
  static const String unsavedChangesMessage = 'لديك تعديلات غير محفوظة. هل تريد الخروج وإهمالها؟';
  static const String unsavedChangesSimple = 'لديك تغييرات غير محفوظة. هل تريد الخروج؟';
  ...
  static const String doNotClosePage = 'برجاء عدم إغلاق الصفحة حتى اكتمال العملية';
  ...
  static const String conversionFactorInfoSimplePrefix = 'معامل التعبئة: تحتوي على ';
  ...
  static const String stockAdjustmentSubtitle = 'تعديل كمية المخزون يدوياً لتطابق الكمية الفعلية على الرف';
  ...
  static const String invalidStockQuantity = 'يرجى إدخال كمية جرد صحيحة أكبر من أو تساوي الصفر';

  // ─── Barcode Settings ───
  static const String barcodeSettingsTitle = 'إعدادات طباعة الباركود';
  static const String barcodeSettingsSubtitle = 'تخصيص أبعاد ملصقات الباركود والبيانات المعروضة عليها للطباعة الحرارية أو الورقية';
  ...
  static const String encodingFormatHint = 'اختر المعيار المناسب لماكينة الطباعة';
  ...
  static const String pharmacySignatureSubtitle = 'توليد بادئة فريدة بناءً على اسم الصيدلية لتمييز أصنافك';
  ...
  static const String barcodePreviewNote = 'تنبيه: المعاينة أعلاه معروضة بنسبة تكبير ٣:١ لتسهيل المراجعة البصرية. أبعاد الملصق الحقيقية ستكون %s × %s مم عند الطباعة.';

  // ─── Barcode Label Printing ───
  static const String barcodePrintTitle = 'طباعة ملصقات الباركود';
  static const String barcodePrintSubtitle = 'تحديد الأصناف وكمية الملصقات المطلوب طباعتها للمخزن';
  ...
  static const String searchMedicineToPrintHint = 'بحث عن صنف لإضافته لقائمة الطباعة...';
  static const String noBarcode = 'بدون باركود';
  static const String emptyPrintListTitle = 'قائمة الطباعة فارغة';
  static const String emptyPrintListSubtitle = 'استخدم محرك البحث أعلاه لإضافة الأصناف المطلوب طباعة ملصقات لها.';
  ...
  static const String previewMagnifiedNote = '* المعاينة معروضة بضعف الحجم للتوضيح';
  ...
  static const String barcodeTakenElsewhereError = 'الباركود "%s" مستخدم بالفعل في دواء آخر!';
  static const String internalConversionFactorLabel = 'معامل التحويل الداخلي وتفتيت العبوة';
  static const String confirmDateAction = 'اعتماد التاريخ';

  static const String openingShortageInvoicesFormat = 'جاري فتح فواتير النواقص لطلب %s...';
  ...
  static const String itemsRestoredSuccess = 'عادت الأصناف المحددة إلى دليل الأصناف.';
  static const String itemsRestorePartial = 'تم استعادة الأصناف بنجاح مع بعض الاستثناءات.';
  static const String itemsDeletedPermanently = 'تم حذف الأصناف المحددة نهائيًا.';
  static const String itemsDeletePartial = 'تم الحذف النهائي مع بعض الاستثناءات.';
  ...
  static const String addMedicineToInventoryTitle = 'إضافة دواء جديد إلى المخزون';
  ...
  static const String confirmDeleteAllMessage = 'هل تريد حذف كل الأدوية (%s)؟ هذا الإجراء لا يمكن التراجع عنه.';
  static const String confirmDeleteSelectedTitle = 'تأكيد الحذف';
  static const String confirmDeleteSelectedMessage = 'هل تريد حذف %s دواء محدّد؟';
  ...
  static const String bulkPriceUpdateDesc = 'تعديل أسعار الشراء والبيع لمجموعة من الأدوية دفعة واحدة';
  ...
  static const String bulkPriceUpdateConfirm = 'هل أنت متأكد من تحديث أسعار %s صنف؟';
