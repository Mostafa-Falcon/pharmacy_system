            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  icon: Icon(Icons.close_rounded, size: AppIconSize.md.value, color: AppColors.textSecondaryOf(context)),
                ),
              ],
            ),
          ),
      ...
      return Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(Icons.no_photography_rounded, size: AppIconSize.xl.value, color: AppColors.error),
              SizedBox(height: AppSpacing.md.h),
              ReusableText(
                _error ?? AppStrings.barcodeCameraDenied,
                style: AppTextStyles.body(context).copyWith(color: AppColors.error, fontWeight: FontWeight.w600),
            ...
            WidgetsBinding.instance.addPostFrameCallback((_) {
              if (mounted && _hasPermission) {
                setState(() {
                  ...
                  _error = AppStrings.barcodeCameraError.replaceFirst('%s', error.errorCode.name);
                });
              }
            });
        ...
        if (_isScanned)
          Positioned.fill(
            child: Container(
              ...
              child: Center(
                child: Icon(Icons.check_circle_rounded, size: AppIconSize.xxl.value, color: AppColors.success),
              ),
            ),
          ),
      ],
