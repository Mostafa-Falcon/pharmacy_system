      ...
      pageListBuilder: (modalSheetContext) {
        return [
          WoltModalSheetPage(
            ...
            child: Padding(
              padding: EdgeInsets.fromLTRB(16.w, 16.h, 16.w, 100.h), // Extra padding at bottom to avoid blocking by sticky action bar
              child: Form(
                key: formKey,
                child: Column(
                  ...
                  children: [
                    ...
                    ReusableInput(
                      ...
                      validator: (val) {
                        ...
                        if (num == null || num <= 0) {
                          return AppStrings.paymentValidNumber;
                        }
                        return null;
                      },
                    ),
                    ...
                    ReusableInput(
                      ...
                      hint: AppStrings.paymentNotesHint,
