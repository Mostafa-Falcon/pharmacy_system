...
class ReusablePagination extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveItemLabel = itemLabel ?? AppStrings.paginationItemLabel;
        ...
        ? Row(
            ...
            children: [
              ...
              ReusableDropdown<int>(
                value: pageSize,
                hintText: AppStrings.paginationPageSize,
    ...
    final navControls = Row(
      ...
      children: [
        ...
        ReusableText(
          AppStrings.paginationPageFormat.replaceFirst('%s', '$page').replaceFirst('%s', '$pageCount'),
