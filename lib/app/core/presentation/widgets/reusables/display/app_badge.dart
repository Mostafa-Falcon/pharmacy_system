...
class AppBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveRadius = borderRadius ?? BorderRadius.circular(AppRadius.pill);
    final effectivePadding = padding ?? EdgeInsets.symmetric(horizontal: 10.w, vertical: 4.h);
      ...
      child: Row(
        ...
        children: [
          ...
          FittedBox(
            ...
            child: ReusableText(
              label,
              style: AppTextStyles.caption(context).copyWith(fontWeight: FontWeight.w700, color: foreground),
            ),
          ),
        ],
      ),
