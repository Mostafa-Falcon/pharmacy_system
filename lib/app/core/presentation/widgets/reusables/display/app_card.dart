...
class _CardInteractiveWrapper extends StatefulWidget {
  ...
  @override
  State<_CardInteractiveWrapper> createState() => _CardInteractiveWrapperState();
}
            ...
            ? Column(
                ...
                children: [
                  ...
                  ReusableText(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: AppTextStyles.body(context).copyWith(fontWeight: FontWeight.w800, color: cardColor),
                  ),
                  if (subtitle != null) ...[
                    SizedBox(height: 2.h),
                    ReusableText(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                ReusableText(
                  value,
                  style: AppTextStyles.body(context).copyWith(fontWeight: FontWeight.w900, color: color),
                ),
                if (subtitle != null) ...[
                  SizedBox(height: 2.h),
                  ReusableText(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ReusableText(
                amount,
                style: AppTextStyles.body(context).copyWith(fontWeight: FontWeight.w900, color: iconColor),
              ),
              SizedBox(height: 2.h),
              ReusableText(
                date,
          ...
          if (menuItems != null && menuItems!.isNotEmpty) ...[
            ...
            PopupMenuButton<String>(
              icon: Icon(Icons.more_vert_rounded, size: 20.sp, color: AppColors.textSecondaryOf(context)),
