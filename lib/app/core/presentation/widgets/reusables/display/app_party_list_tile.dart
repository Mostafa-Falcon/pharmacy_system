      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: selected
              ...
              : AppColors.borderOf(context).withValues(alpha: isDark ? 0.3 : 0.5),
          width: 1.w,
        ),
      ),
      child: ClipRRect(
                ...
                children: [
                  Container(
                    ...
                    child: avatarIcon != null
                        ? Icon(avatarIcon, size: AppIconSize.md.value, color: aColor)
                        : ReusableText(
                            (avatarText != null && avatarText!.isNotEmpty)
                                ? avatarText!.characters.first
                                : '?',
                            style: AppTextStyles.body(context).copyWith(fontWeight: FontWeight.w800, color: aColor),
                          ),
                  ),
