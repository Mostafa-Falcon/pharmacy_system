...
import 'app_sizes.dart'; // استدعاء ملف الأبعاد والـ Radius الموحد لتثبيت الحواف
...
class AppTheme {
  ...
  static ThemeData _buildLight() {
    final scheme = ColorScheme.fromSeed(
      ...
      // ضبط درجات الخلفيات المدمجة للماتيريال 3 لراحة شاشات الجرد الكبيرة
    ...
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
      fontFamily: 'Cairo', // لغة الحوار العربي والخط الموحد بامتياز
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(AppRadius.lg), // ربط آمن مع الحواف الموحدة
