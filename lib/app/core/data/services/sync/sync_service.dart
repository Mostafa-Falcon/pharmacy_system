...
import 'package:pharmacy_system/app/core/config/sync_config.dart';
...
export 'package:pharmacy_system/app/core/data/services/sync/sync_models.dart';
...
class SyncService {
  ...
  static Future<List<OutboxTableData>> getPendingItems() async {
  ...
  static Future<List<OutboxTableData>> getDeadLetterItems() async {
    return (_db.select(_db.outboxTable)..where(
          (t) =>
              t.syncedAt.isNull() &
