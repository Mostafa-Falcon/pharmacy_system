...
class MedicineSearchField extends StatefulWidget {
  ...
  const MedicineSearchField({
    ...
    this.label = WidgetStrings.medicineSearchHint,
    this.hint = WidgetStrings.medicineSearchPlaceholder,
...
class _MedicineSearchFieldState extends State<MedicineSearchField> {
                ...
                children: [
                  ...
                  AppText(
                    WidgetStrings.medicineSearchStock
                        .replaceFirst(
                          '%s',
                          medicine.barcodes.firstOrNull?.code ?? "---",
                        )
                        .replaceFirst('%s', '${medicine.quantity}'),
  ...
  void _onChanged(String value) async {
    ...
    safeDebugPrint(
      'MedicineSearch: Searching "$query" in ${allItems.length} items (Branch: ${AuthService.currentBranchId})',
    );
