...
class SharedFilterBar extends StatelessWidget {
  ...
  const SharedFilterBar({
    ...
    this.searchHint = GeneralStrings.searchHint,
    this.filterWidgets,
    this.onClearFilters,
            ...
            children: [
              ...
              if (activeFilterCount > 0 && onClearFilters != null)
                TextButton.icon(
                  ...
                  label: ReusableText(
                    WidgetStrings.filterClearFormat.replaceFirst('%s', '$activeFilterCount'),
                    style: TextStyle(
                      fontSize: 12.sp,
                      color: scheme.error,
              ...
              if (currentViewMode != null && onViewModeChanged != null) ...[
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      IconButton(
                        tooltip: WidgetStrings.filterViewTable,
                        icon: Icon(
                      ...
                      IconButton(
                        tooltip: WidgetStrings.filterViewGrid,
                        icon: Icon(
