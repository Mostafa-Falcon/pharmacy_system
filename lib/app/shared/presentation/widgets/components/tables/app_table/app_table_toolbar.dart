...
class AppTableToolbar<T> extends StatelessWidget {
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: WidgetStrings.tableSearchHint,
  ...
  Widget _buildColumnPicker(BuildContext context, ColorScheme scheme) {
    ...
    return MenuAnchor(
      builder: (context, controller, child) {
        return Tooltip(
          message: WidgetStrings.tableColumnsVisibility,
      ...
      menuChildren: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              ReusableText(
                WidgetStrings.tableColumnsVisibility,
              ...
              if (onResetColumnsVisibility != null && hiddenCount > 0)
                TextButton(
                  ...
                  child: ReusableText(
                    WidgetStrings.tableDeselectAll,
                    style: AppTextStyles.caption(context).copyWith(
                      color: scheme.primary,
                    ),
                  ),
  ...
  Widget _buildDensityMenu(BuildContext context, ColorScheme scheme) {
    return PopupMenuButton<AppTableDensity>(
      tooltip: WidgetStrings.tableDensity,
  ...
  Widget _buildExportMenu(BuildContext context, ColorScheme scheme) {
    ...
    return PopupMenuButton<String>(
      tooltip: WidgetStrings.tableExport,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(AppRadius.card.r),
      ),
      child: Container(
          ...
          PopupMenuItem<String>(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 8.w),
                ReusableText(WidgetStrings.tableExportExcel),
              ],
            ),
          ),
        if (onExportCsv != null)
          PopupMenuItem<String>(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 8.w),
                ReusableText(WidgetStrings.tableExportCsv),
              ],
            ),
          ),
        if (onPrint != null)
          PopupMenuItem<String>(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 8.w),
                ReusableText(WidgetStrings.tablePrint),
              ],
            ),
          ),
      ],
