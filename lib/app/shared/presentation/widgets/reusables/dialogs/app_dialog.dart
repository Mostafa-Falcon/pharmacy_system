  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: Builder(
        builder: (context) {
          return Center(
            // يضمن التمركز المثالي للديالوج على الشاشات الكبيرة والتابلت
            child: Container(
              width: double.infinity,
              constraints: maxWidth != null
                  ? BoxConstraints(maxWidth: maxWidth!.w)
                  : null, // ضبط العرض الأقصى بالـ .w
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment
                    .stretch, // جعل العناصر تمتد لتطابق محاذاة الأزرار بالملي
                children: [
                  if (hasHeader) ...[
                    Row(
