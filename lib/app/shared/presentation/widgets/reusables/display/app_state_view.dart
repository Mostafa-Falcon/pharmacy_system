...
class AppStateView extends StatelessWidget {
  ...
  const AppStateView.error({
    ...
    this.action,
    this.compact = false,
  }) : title = title ?? WidgetStrings.stateViewError,
       subtitle = message,
  ...
  const AppStateView.permissionDenied({
    ...
    this.action,
    this.compact = false,
  }) : title = title ?? WidgetStrings.stateViewPermissionDenied,
       subtitle = message,
       iconColor = AppColors.warning,
       isLoading = false;

  const AppStateView.loading({super.key, String? message, this.compact = false})
    : title = message ?? GeneralStrings.loading,
      subtitle = null,
  ...
  Widget build(BuildContext context) {
    ...
    final double iconSize = compact
        ? AppIconSize.lg.value
        : AppIconSize.xl.value;
