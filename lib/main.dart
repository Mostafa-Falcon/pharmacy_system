...
import 'package:pharmacy_system/app/core/bloc/app/app_cubit.dart';
import 'package:pharmacy_system/app/core/bloc/app/app_bloc_observer.dart';
...
import 'package:pharmacy_system/app/core/data/services/ui/theme_service.dart';
...
import 'package:pharmacy_system/app/core/theme/app_theme.dart';
...
Future<void> main() async {
  ...
  syncEngine.initialSync(delaySeconds: 5);

  // فحص صحة المنظومة بعد التهيئة
  SystemHealthService.instance.checkHealth();
